...
```bash
kubectl -n $NAMESPACE delete rayjob llm --ignore-not-found
...
# Optional: Monitoring through Ray service
kubectl -n $NAMESPACE port-forward svc/llm-head-svc 8265:8265
# Then open the Ray dashboard: http://localhost:8265
```
